  ...
  try {
    ...
    if (gameIdFromRedis) {
      ...
      if (gameExists) {
        ...
        console.log(`[Computer Game] Player color: ${gameState.playerColor}, Current turn: ${currentTurn}`);
        
        if (gameState.playerColor !== currentTurn) {
          console.log(`[Computer Game] It's computer's turn, calculating move...`);
    ...
    if (gameFromDB) {
      ...
      if (restored) {
        ...
        console.log(`[Computer Game] Player color: ${restored.playerColor}, Current turn: ${currentTurn}`);
