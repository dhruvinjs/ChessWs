...
export const LoadingScreen = () => {
  ...
  const getCurrentMessage = () => {
    const messageIndex = Math.floor((Date.now() / 2500) % loadingMessages.length);
