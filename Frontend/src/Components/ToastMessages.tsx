...
interface MessageOptions {
  type: "success" | "error" | "info" | "warning" | "check" | "victory" | "defeat";
...
export const showMessage = (
  ...
  const toastOptions = {
    ...
    style: {
      ...
      fontSize: "16px",
      fontWeight: 600,
      boxShadow: "0 12px 30px -8px rgba(0, 0, 0, 0.4), 0 6px 8px -4px rgba(0, 0, 0, 0.2)",
      minWidth: "320px",
      maxWidth: "500px",
  ...
  <Toaster
    ...
    toastOptions={{
      ...
      style: { 
        ...
        maxWidth: "500px",
        borderRadius: "16px",
        boxShadow: "0 12px 30px -8px rgba(0, 0, 0, 0.5), 0 6px 8px -4px rgba(0, 0, 0, 0.3)",
        backdropFilter: "blur(10px)",
      },
      duration: 4000,
